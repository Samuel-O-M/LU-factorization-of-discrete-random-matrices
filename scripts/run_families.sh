#!/bin/bash
#SBATCH --job-name=families
#SBATCH --output=families_%j.out
#SBATCH --error=families_%j.err
#
# Default SLURM configuration for families computation
...
#
# Usage:
#   sbatch scripts/run_families.sh                    # Use defaults
#   SBATCH_PARTITION=gpu sbatch scripts/run_families.sh  # Override partition
#
